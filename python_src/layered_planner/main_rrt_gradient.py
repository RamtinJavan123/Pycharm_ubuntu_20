...
obstacles = [
    # narrow passage
    np.array([[0, 0], [-passage_location - passage_width / 2., -0.0], [-passage_location - passage_width / 2., 0.0],
              [0.0, 0.0]]),
    np.array([[-passage_location + passage_width / 2., 0], [0, 0], [0.0, 0.0],
              [-passage_location + passage_width / 2., 0.0]]),
]
